...
<a name="respond"></a>	<h3>have your say</h3>
					...
					<div style="background-color: #f3f3f3; padding: 10px;">		<?php if (('open' == $post-> comment_status) && ('open' == $post->ping_status)) {
							...
							Add your comment below, or <a href="<?php trackback_url(true); ?>" rel="trackback">trackback</a> from your own site. <?php post_comments_feed_link('Subscribe to these comments.'); ?>
